...
function getSystemName()
{
    ...
    if ($systemNameResult->num_rows > 0) {
     ...
     <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
       ...
       <div class="sidebar-brand-text mx-3"><span class="brand-text font-weight-light"><?php echo getusername(); ?></span></div>
     </a>
     ...
     <li class="nav-item">
       ...
       <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" href="buttons.html">Bill</a>
           <a class="collapse-item" href="cards.html">Usage</a>
         </div>
       </div>
     </li>
     ...
     <li class="nav-item">
       <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
         ...
         <span>View Consumer Details</span>
       </a>
           ...
           <li class="nav-item dropdown no-arrow">
             <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                 ...
                 <div class="sidebar-brand-text mx-3"><span class="brand-text font-weight-light"><?php echo getUserRole(); ?></span></div>
