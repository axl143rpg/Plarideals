    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        ...
        if (strpos($_SERVER['REQUEST_URI'], 'add_members.php') !== false) {
          ...
          $pageTitle = 'Renewal';
        } elseif (strpos($_SERVER['REQUEST_URI'], 'manage_users.php') !== false) {
          ...
          $pageTitle = 'Dashboard';
        } elseif (strpos($_SERVER['REQUEST_URI'], 'userProfile.php') !== false) {
          $pageTitle = 'Users Profile';
        } elseif (strpos($_SERVER['REQUEST_URI'], 'consumers.php') !== false) {
